        ...
        {/* <div className='home-sec-2'>
          ...
          <div style={{ width: '70vw', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
            <div className='sec-2-text' style={{ paddingTop: '30px' }}>
              <p>
                Indiansignlanguage.org offers a huge collection of Indian Sign Language (SL) signs.
              ...
              <p>
                ...
                and naturally. With a focus on accessibility and inclusivity, SignSpeaks offers a seamless video experience tailored to the
          ...
          <div className="midea-3" style={{ display: 'flex', justifyContent: 'center', gap: '70px' }}>
            <div className='bubble bubble1'>
              <div className='in-bubble'>
                <h4 className='in-bubble-h4'>SL Video <br />to <br />Text</h4>
                <p className='in-bubble-p'>Converts <br />SL Videos<br /> intoText<br /> and then into <br />Speech.</p>
              </div>
            </div>
            <div className='bubble  bubble2'>
              <div className='in-bubble'>
                <h4 className='in-bubble-h4'>Text <br />to <br />SL Video</h4>
                <p className='in-bubble-p'>Easily Translate Typed Text into SL Videos.</p>
              </div>
            </div>
            ...
            <div className='bubble bubble5'>
              <div className='in-bubble'>
                <h4 className='in-bubble-h4'>Voice <br />to<br />SL Video</h4>
                <p className='in-bubble-p'>Converts Recorded Speech<br /> into Text and  Translates it<br />into an SL video.</p>
              </div>
            </div>
          </div>
        </div> */}
